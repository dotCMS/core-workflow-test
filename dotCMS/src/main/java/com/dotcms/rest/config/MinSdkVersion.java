 ...
 * PR. Instead:
 * <ol>
 *   <li>Get your PR labeled {@code AI: SDK Breaking Change} — an automated check
 *       ({@code ai_claude-sdk-breaking-change.yml}) evaluates every PR's diff against
 *       {@code docs/core/SDK_BREAKING_CHANGE_CATEGORIES.md}. If you disagree with its
 *       verdict, apply {@code Human: SDK Breaking Change} or
 *       {@code Human: Not SDK Breaking Change} yourself to override it.</li>
